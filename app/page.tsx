        ...
        <div className="relative mx-auto grid max-w-6xl items-center gap-12 px-6 py-16 lg:grid-cols-2 lg:py-24">
          <div>
            ...
            <p className="mt-5 max-w-lg text-base leading-relaxed text-muted-foreground">
              Peptide Pharma is an independent research organization
              designing next-generation peptide therapeutics through synthesis,
              structural biology, and translational science.
            </p>
