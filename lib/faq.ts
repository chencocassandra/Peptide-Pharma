export const faqs = [
  {
    ...
    a: "No. Catalogue items are laboratory research chemicals only. They are not medicines or supplements, and they are not offered for human or veterinary use, diagnosis, treatment, or prevention of disease.",
  },
  {
  ...
  },
  {
    ...
    a: "Use the contact form or email research@peptidepharma.com for SKUs, documentation, quotes, and order questions. Reagent enquiries are usually answered within two business days.",
  },
] as const;
